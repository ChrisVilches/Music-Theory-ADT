...
public class ChordTest {
	 ...
	 * @param notes
	 */
	private void assertChord(Note note, ChordType chordType, String[] notes){
	...
	private void assertChord(Chord chord, String[] notes){
	...
	public final void testChordTooHigh2(){		
		...
		Chord chord = new Chord(note, ChordType.MAJ7);
		chord.getNotes();
	}
	...
	public final void testChordTooHigh3(){		
		...
		Chord chord = new Chord(note, ChordType.MIN7);
		chord.getNotes();
	}
	...
	public final void testTranspose2(){
		...
		for (ChordType type : ChordType.values()) {
			...
			for(int i=1; i<Note.MAX_OCTAVE; i++){				
